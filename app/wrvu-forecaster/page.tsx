              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <ScreenInfoModal
                      title="Work Schedule"
                      description="Enter your work schedule details to calculate your available working time throughout the year.\n\n• Vacation Weeks: Number of weeks you take off for vacation\n• Statutory Holidays: Number of statutory holidays per year\n• CME Days: Days allocated for Continuing Medical Education\n• Shift Types: Define different shift types with hours per shift and frequency per week\n\nThis information is used to calculate:\n• Weeks worked per year\n• Annual clinic days\n• Annual clinical hours\n\nThese calculations form the foundation for estimating your patient encounters and productivity."
                    />
                  </CardTitle>
                </div>
              </CardHeader>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <ScreenInfoModal
                      ...
                      description="Enter patient encounter metrics to determine your productivity and wRVU generation.\n\n• Input Mode: Toggle between 'Per Hour' or 'Per Day' based on how you track patient volume\n• Patients Seen Per Hour/Day: Your average patient volume during clinical time\n• Average wRVU Per Encounter: The typical wRVU value assigned to your patient encounters\n• Adjusted wRVU Per Encounter (Optional): Use this to model scenarios with different wRVU values per encounter\n\nThese metrics are combined with your work schedule to calculate:\n• Encounters per week\n• Annual patient encounters\n• Estimated annual wRVUs\n\nThe adjusted wRVU field allows you to model 'what-if' scenarios, such as changes in case complexity or coding practices."
                    />
                  </CardTitle>
                </div>
              </CardHeader>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="flex items-center gap-2">
                    ...
                    <ScreenInfoModal
                      title="Compensation"
                      description="Enter your compensation structure to calculate total earnings.\n\n• Base Salary: Your guaranteed annual base compensation\n• wRVU Conversion Factor: The dollar amount paid per wRVU for productivity incentives (e.g., $45.52/wRVU)\n• Target Annual wRVUs: Automatically calculated as Base Salary ÷ Conversion Factor\n\nYour total compensation is calculated as:\n• wRVU Compensation = Annual wRVUs × Conversion Factor\n• Total Compensation = Maximum of (Base Salary, wRVU Compensation)\n\nThis means you'll receive whichever is higher: your base salary or your productivity-based compensation. The system shows you both the base guarantee and potential incentive earnings."
                    />
                  </CardTitle>
                </div>
              </CardHeader>
