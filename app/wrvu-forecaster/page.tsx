  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-24 sm:pb-6">
      ...
      <div className="no-print">
        ...
        {activeTab === 'input' && (
          <div className="sticky bottom-20 md:static bg-white dark:bg-gray-900 pt-3 pb-3 sm:pt-4 sm:pb-4 border-t border-gray-200 dark:border-gray-800 safe-area-inset-bottom z-10">
            <div className="flex flex-row gap-3">
              <Button
                variant="outline"
                onClick={() => {
