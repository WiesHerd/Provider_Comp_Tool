...
import { DollarSign, User, Stethoscope, ChevronDown, Info, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-24 sm:pb-6">
      ...
      <div className="no-print">
        ...
        {/* Continue Button - Sticky bottom bar for Setup tab */}
        {activeTab === 'setup' && (
          <div className="sticky bottom-20 md:bottom-0 bg-white dark:bg-gray-900 pt-4 pb-4 sm:pb-6 border-t border-gray-200 dark:border-gray-800 safe-area-inset-bottom z-10">
            <div className="flex flex-row gap-3">
              <Button
                ...
                className="flex-1 min-h-[48px] text-base font-semibold flex items-center"
                size="lg"
              >
        ...
        {/* View Results Button - Sticky bottom bar for Input tab */}
        {activeTab === 'input' && (
          <div className="sticky bottom-20 md:bottom-0 bg-white dark:bg-gray-900 pt-3 pb-3 sm:pt-4 sm:pb-4 border-t border-gray-200 dark:border-gray-800 safe-area-inset-bottom z-10">
            <div className="flex flex-row gap-3">
              <Button
                variant="outline"
                onClick={() => {
              ...
              <Button
                ...
                className="flex-1 min-h-[44px] text-sm sm:text-base font-semibold flex items-center"
              >
                View Results
                <ChevronRight className="w-4 h-4 ml-2 flex-shrink-0" />
              </Button>
