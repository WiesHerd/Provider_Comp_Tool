  ...
  return (
    <div className="w-full px-3 sm:px-6 lg:max-w-4xl lg:mx-auto py-4 sm:py-6 md:py-8">
      ...
      <div className="no-print">
        <ProgressiveForm
          totalSteps={4}
          stepNames={['Work Schedule', 'Patient Encounters', 'Compensation', 'Results']}
          validateStep={(step) => {
            ...
            <Card variant="borderless">
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  {/* Title removed - header already shows "Work Schedule" */}
                  <ScreenInfoModal
                      title="Work Schedule"
                      description={`## Overview
Enter your work schedule details to calculate your available working time throughout the year. This forms the foundation for all productivity calculations.

## Required Fields

### Time Off
• Vacation Weeks: Number of weeks you take off for vacation
• Statutory Holidays: Number of statutory holidays per year
• CME Days: Days allocated for Continuing Medical Education

### Shift Types
Define different shift types with their characteristics:
  • Shift Name: Descriptive name (e.g., Regular Clinic, Extended Hours)
  • Hours Per Shift: Duration of each shift
  • Frequency Per Week: How many times per week this shift occurs

## Calculations
This information is used to calculate:
• Weeks worked per year: Total working weeks after subtracting time off
• Annual clinic days: Total clinic days available per year
• Annual clinical hours: Total clinical hours available per year

## Impact
These calculations form the foundation for estimating:
• Patient encounters per week and per year
• Annual wRVU production
• Productivity-based compensation`}
                    />
                </div>
              </CardHeader>
              <CardContent data-tour="forecaster-schedule">
                <WorkSchedulePanel
                  inputs={inputs}
            ...
            <ProgressiveFormNavigation nextLabel="Continue to Patient Encounters" />
          </ProgressiveFormStep>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <ScreenInfoModal
                      ...
                      description={`## Overview
Enter patient encounter metrics to determine your productivity and wRVU generation. These metrics are combined with your work schedule to calculate annual productivity.

## Input Fields

### Input Mode Toggle
• Toggle between Per Hour or Per Day based on how you track patient volume
• Switch changes the input field label and calculation method
• Choose the mode that matches your workflow

### Patient Volume
• Patients Seen Per Hour: Your average patient volume per hour (when in Per Hour mode)
• Patients Seen Per Day: Your average patient volume per day (when in Per Day mode)

### wRVU Values
• Average wRVU Per Encounter: The typical wRVU value assigned to your patient encounters
• Adjusted wRVU Per Encounter (Optional): Use this to model scenarios with different wRVU values per encounter

## Calculations
These metrics are combined with your work schedule to calculate:
• Encounters per week
• Annual patient encounters
• Estimated annual wRVUs

## Modeling Scenarios
The adjusted wRVU field allows you to model what-if scenarios:
• Changes in case complexity
• Coding practice improvements
• Specialty mix variations
• See potential impact on compensation`}
                    />
                </div>
              </CardHeader>
              <CardContent data-tour="forecaster-encounters">
                <div className="space-y-4">
                  ...
                  <NumberInputWithButtons
                    label="Adjusted wRVU Per Encounter (Optional)"
            ...
            <ProgressiveFormNavigation nextLabel="Continue to Compensation" />
          </ProgressiveFormStep>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <ScreenInfoModal
                      title="Compensation"
                      description={`## Overview
Enter your compensation structure to calculate total earnings. This combines your base salary guarantee with productivity-based incentives.

## Required Fields

### Base Salary
• Your guaranteed annual base compensation
• Acts as a floor for total compensation
• You will receive at least this amount

### wRVU Conversion Factor
• The dollar amount paid per wRVU for productivity incentives
• Example: $45.52 per wRVU
• Multiplied by your annual wRVUs to calculate productivity pay

### Target Annual wRVUs
• Automatically calculated as Base Salary ÷ Conversion Factor
• Represents the wRVU threshold where productivity pay equals base salary
• Useful for understanding your productivity targets

## Compensation Calculation

### Formula
• wRVU Compensation = Annual wRVUs × Conversion Factor
• Total Compensation = Maximum of (Base Salary, wRVU Compensation)

### How It Works
• You receive whichever is higher: base salary or productivity-based compensation
• Base salary provides a guaranteed minimum
• Productivity pay provides upside potential
• The system shows both the base guarantee and potential incentive earnings`}
                    />
                </div>
              </CardHeader>
            ...
            <ProgressiveFormNavigation nextLabel="Calculate Forecast" />
          </ProgressiveFormStep>

          {/* Step 4: Results */}
          <ProgressiveFormStep step={4}>
            <Card variant="borderless" className="md:border-2 md:border-primary/20 md:dark:border-primary/30 md:shadow-lg">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <StepBadge number={4} variant="completed" />
                    {/* Results title kept - it's the final step summary */}
                    <CardTitle className="text-base sm:text-lg">Forecast Results</CardTitle>
                  </div>
                  <ScenarioManager
                    inputs={inputs}
                    metrics={metrics}
