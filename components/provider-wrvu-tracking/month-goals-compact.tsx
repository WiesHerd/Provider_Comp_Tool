    ...
    <div className={cn("flex items-center gap-2 flex-wrap min-w-0", className)}>
      {goals?.targetPatients && (
        <button
          ...
          className={cn(
            "inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-full",
        ...
        >
          ...
          <span className="font-semibold">{goals.targetPatients}</span>
          <span className="text-blue-500 dark:text-blue-400 hidden sm:inline">patients</span>
          <span className="text-blue-500 dark:text-blue-400 sm:hidden">pts</span>
          {actualPatients > 0 && (
            <span className={cn(
              "px-1.5 sm:px-2 py-0.5 rounded text-[10px] sm:text-xs font-semibold whitespace-nowrap flex-shrink-0",
          ...
          <Edit2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 opacity-0 group-hover:opacity-100 transition-opacity ml-0.5 flex-shrink-0 hidden sm:block" />
        </button>
      )}
      ...
      {goals?.targetWRVUs && (
        ...
        >
          <Target className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" />
          <span className="font-semibold">{goals.targetWRVUs.toFixed(0)}</span>
      ...
      {(!goals?.targetPatients || !goals?.targetWRVUs) && (
        <button
          ...
          className={cn(
            "inline-flex items-center justify-center gap-1 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-full",
            "text-xs sm:text-sm font-medium touch-target",
