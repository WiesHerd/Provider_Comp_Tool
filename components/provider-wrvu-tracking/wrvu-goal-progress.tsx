...
export function WRVUGoalProgress({
  ...
  // If no goals set, show message
  if (!goals?.targetPatients && !goals?.targetWRVUs) {
    return (
      <Card className="border-2">
        ...
        <CardContent>
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-8">
            Set goals for {monthName} in the Tracking tab to see progress and projections here.
          </p>
        </CardContent>
      </Card>
    );
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {goals.targetPatients && (
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Target Patients</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">
                  {formatNumber(goals.targetPatients)}
                </p>
              </div>
            )}
            {goals.targetWRVUs && (
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Target wRVUs</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">
                  {formatNumber(goals.targetWRVUs, 2)}
                </p>
              </div>
            )}
          </div>
