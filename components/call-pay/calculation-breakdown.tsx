    ...
    <div className={cn('space-y-6', className)}>
      <div className="mb-4">
        ...
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          Step-by-step breakdown of how your inputs translate to annual budget
        </p>
      </div>
          ...
          <div className="space-y-3">
            {breakdown.steps.map((step, index) => (
              ...
              >
                ...
                <div
                  className={cn(
                    'absolute -left-4 top-0 w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold',
                    step.highlight
