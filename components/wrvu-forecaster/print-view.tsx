...
export function PrintView({ metrics, inputs }: PrintViewProps) {
  ...
  return (
    <>
      ...
      `}} />
      <div className="print-view" style={{ marginTop: 0, paddingTop: 0 }}>
      {/* Header with Logo */}
      <div className="flex justify-between items-start mb-2 pb-2 border-b-2 border-gray-400" style={{ pageBreakAfter: 'avoid' }}>
        <div className="flex-1">
          <h1 className="text-base font-bold text-gray-900 mb-0.5" style={{ marginTop: 0 }}>Provider Schedule & wRVU Forecast Report</h1>
