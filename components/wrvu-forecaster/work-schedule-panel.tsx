  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pt-4 border-t-2 border-gray-200 dark:border-gray-800">
        ...
        <div className="grid grid-cols-[100px_80px_80px_44px] sm:grid-cols-[1fr_100px_120px_44px] gap-2 mb-2">
        ...
        <div className="space-y-2 sm:space-y-3">
          {inputs.shifts.map((shift, index) => (
            <div key={shift.id} className="grid grid-cols-[100px_80px_80px_44px] sm:grid-cols-[1fr_100px_120px_44px] gap-2 items-center p-2 sm:p-0 rounded-lg border border-gray-200 dark:border-gray-700 sm:border-0 bg-gray-50 dark:bg-gray-800/50 sm:bg-transparent">
              {/* Shift Name */}
              <Input
                value={shift.name}
